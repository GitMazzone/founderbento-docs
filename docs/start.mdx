...
**Quickstart**: Three 5-minute guides to add the bare minimum features. You'll have a beautiful landing page deployed in 15 minutes!  
**Features**: Set up features like payments and emails. Used to take hours, now takes minutes.  
